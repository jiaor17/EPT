...
def cif_to_blocks(cif: str, selected_chains: Optional[List[str]]=None) -> List[List[Block]]:
    parser = MMCIFParser()
    structure = parser.get_structure('anonym', cif)
...
if __name__ == "__main__":
    list_blocks = cif_to_blocks("./AF-A0A2R8QQ98-F1-model_v4.cif", ['A'])
    print(list_blocks)

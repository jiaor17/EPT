...
@R.register('QM9Dataset')
class QM9Dataset(MMAPDataset):

    target_properties = ['mu', 'alpha', 'homo', 'lumo', 'gap', 'r2', 'zpve', 'U0', 'U', 'H', 'G', 'Cv']
    ...
    def __init__(self, mmap_dir: str, property: str) -> None:
        ...
        self._properties = [float(x[prop_idx]) for x in self._properties] # number of blocks in each data
